...
- debdff7: Fix: a daily, weekly, monthly or yearly bar has no time-of-day component, but the time axis and the
...
- d844dc2: Fix: a chart whose loaded bars don't fill the pane (e.g. a Year view with only a few candles) could
